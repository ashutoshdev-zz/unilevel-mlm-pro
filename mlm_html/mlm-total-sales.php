			...
			<div class="va-admin-leg-details">
				...
				<div class="paging">
				  <form action="">
					...
					<?php _e('Consultants','unilevel-mlm-pro');?>: &nbsp; <?php _e('Left','unilevel-mlm-pro');?>: <strong><?php  echo   $leftLegUsers; ?></strong>&nbsp;<?php _e('Right','unilevel-mlm-pro');?>: <strong><?php  echo   $rightLegUsers; ?></strong>
					&nbsp; <?php _e('Total','unilevel-mlm-pro');?>: <strong><?php  echo   $totalConsultant;?></strong>
					</div>
