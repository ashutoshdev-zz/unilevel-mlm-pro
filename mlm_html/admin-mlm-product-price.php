...
$tabs = array(
						'add' => __('Add New Product','unilevel-mlm-pro') ,
						'view' => __('View Products','unilevel-mlm-pro')
              );
...
if(isset($_POST['add_price']))
{
		...
		{
			$chk = '';
			mysql_query("insert into {$table_prefix}mlm_product_price (p_id,product_name,product_price) values ('','".$product_name."','".$product_price."')");
			$msg = _e("<span style='color:green;'>Your product price details has been successfully updated.</span>",'unilevel-mlm-pro');
		}
...
<TR>
<TD align="left" width="44%"> <strong><?php _e('Product Name','unilevel-mlm-pro');?></strong></TD>
<TD align="left" width="44%"> <INPUT type="text" name="product_name" size="15" value="" class="text" required/> </TD></TR>

<TR>
<TD align="left" width="44%"> <strong><?php _e('Product Price','unilevel-mlm-pro');?></strong></TD>
...
<p class="submit">
<input type="submit" name="add_price" id="add_price" value="<?php _e('Update Options', 'unilevel-mlm-pro');?> &raquo;" class='button-primary' >
</p></TD></TR>
</TABLE>
</form>
...
$query=mysql_query("select * from {$table_prefix}mlm_product_price where p_id!='1' order by p_id");

if(isset($_POST['update']))
{
mysql_query("update {$table_prefix}mlm_product_price set product_name='".$_POST['product_name']."',product_price='".$_POST['product_price']."' where p_id='".$_POST['p_id']."'");
}
else if(isset($_POST['delete']))
{

mysql_query("delete from {$table_prefix}mlm_product_price where p_id='".$_POST['p_id']."'");
}
...
<div class="notibar msginfo">
		<a class="close"></a>	
		<p><?php _e('Use this section to update the product name and / or product price.','unilevel-mlm-pro');?></p>	
	</div>
<TABLE id="dataTableheading" cellspacing="5" cellpadding="5"  border="0" width="450">
<TR>
<TD align="left" width="34%"> <strong><?php _e('Product Name','unilevel-mlm-pro');?></strong></TD>

<TD align="left" width="24%"> <strong><?php _e('Product Price','unilevel-mlm-pro');?></strong></TD>
<TD>&nbsp;</TD>
</TR>
<?php
...
<div class='wrap1'>
<h2><?php _e('Product Price','unilevel-mlm-pro');?>  </h2>
...
<p class="submit">
<input type="submit" name="mlm_product_price_settings" id="mlm_product_price_settings" value="<?php _e('Update Options', 'unilevel-mlm-pro');?> &raquo;" class='button-primary' onclick="needToConfirm = false;">
</p>
</td><tr></table>
