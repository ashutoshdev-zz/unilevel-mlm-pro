...
<div class='wrap1'>
	<h2><?php _e('Currency Setting','unilevel-mlm-pro');?> </h2>
		...
		<p><strong><?php _e('Use WP registration page','unilevel-mlm-pro');?> - </strong> <?php _e(' Select this option in case you want to use the default WP registration page or a custom registration page on your site. ','unilevel-mlm-pro');?></p>
		<p><strong><?php _e('URL of registration page','unilevel-mlm-pro');?> - </strong> <?php _e(' In case you selected the Use WP registration page option specify the URL of your registration page. This would enable us to setup the correct redirect for the registration page included in our plugin. ','unilevel-mlm-pro');?></p>
...
?>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="60%" class="form-table">
		...
		<input type="text" name="single-sale" id="single-sale" size="10" value="<?php //if(!empty($_POST['single-sale'])) _e(htmlentities($_POST['single-sale']));?>">
				<div class="toggle-visibility" id="admin-mlm-single-sale"><?php //_e('Please specify value of single sale.','unilevel-mlm-pro');?></div>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php  echo   site_url() . '/' ?><input type="text" name="reg_url" id="reg_url" value="<?php  echo   empty($_POST['reg_url']) ? '' : $_POST['reg_url'] ?>" readonly="true"/>
                            </td>
	                      ...
	                      <tr>
                            ...
                            <td>
                                <?php  echo   site_url() . '/' ?><input type="text" name="affiliate_url" id="affiliate_url" value="<?php  echo   empty($_POST['affiliate_url']) ? '' : $_POST['affiliate_url'] ?>" />
                            </td>
		...
		<?php } ?>
			...
			{
			?>
			<input class="radio" type="radio" name="ePin_activate" value="0" <?php if(isset($_POST['ePin_activate'])&&$_POST['ePin_activate']!='1'){echo 'checked';} else {echo 'checked';}?>/> <?php _e('No', 'unilevel-mlm-pro');?>
			<?php }?>
			</td>
		</tr>
		<tr class="sole_id" >
			...
			<input class="radio" type="radio" name="sol_payment" value="0" <?php if(isset($_POST['sol_payment'])&&$_POST['sol_payment']!='1'){echo 'checked';} else {echo 'checked';}?>/> <?php _e('No', 'unilevel-mlm-pro');?>
			</td>
		</tr>
		<tr class="sole_id">
		...
		<input type="text" name="single-sale" id="single-sale" size="10" value="<?php //if(!empty($mlm_settings['single-sale'])) _e($mlm_settings['single-sale']);?>">
				<div class="toggle-visibility" id="admin-mlm-single-sale"><?php //_e('Please specify value of single sale.','unilevel-mlm-pro');?></div>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php  echo   site_url() . '/' ?><input type="text" name="reg_url" id="reg_url" value="<?php  echo   empty($mlm_settings['reg_url']) ? '' : $mlm_settings['reg_url'] ?>" onblur="show1()" readonly="true" />
                        </td>
                            ...
                            <td>
                                <?php  echo   site_url() . '/' ?><input type="text" name="affiliate_url" id="affiliate_url" value="<?php  echo   empty($mlm_settings['affiliate_url']) ? '' : $mlm_settings['affiliate_url'] ?>" />
                            </td>
