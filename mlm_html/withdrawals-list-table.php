...
class Withdrawals_List_Table extends WP_List_Table {
    ...
    function get_columns(){
        $columns = array(
			...
			//'paymentdate'  	=> __('Payment Details','unilevel-mlm-pro')
    ...
    function prepare_items() {
		...
		$listArrtitle['username'] = __('User Name', 'unilevel-mlm-pro');
		$listArrtitle['useremail'] = __('User Email', 'unilevel-mlm-pro');
		$listArrtitle['withdrawaldate'] = __('Withdrawal Date', 'unilevel-mlm-pro');
		$listArrtitle['withdrawalamount'] = __('Withdrawal Amount', 'unilevel-mlm-pro');
		$listArrtitle['withdrawalmode'] = __('Withdrawal Mode', 'unilevel-mlm-pro');
		$listArrtitle['withdrawalcomments'] = __('Withdrawal Comment', 'unilevel-mlm-pro');
		$listArrtitle['paymentdetails'] = __('Payment Details', 'unilevel-mlm-pro');
		//$listArrtitle['paymentdate'] = __('Payment Date', 'unilevel-mlm-pro');
