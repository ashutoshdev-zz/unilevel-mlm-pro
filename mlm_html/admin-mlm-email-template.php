...
//--><!]]></script>
	...
	<h2><?php _e('Email Templates', 'unilevel-mlm-pro'); ?></h2>
...
<form method="post">
	...
	<h3 style="margin-bottom:0"><?php _e('Payout Received Mail', 'unilevel-mlm-pro'); ?> </h3>
	<table class="form-table">
		
		<tr valign="top">
			<th scope="row" style="border:none" class="WLRequired"><?php _e('Subject', 'unilevel-mlm-pro'); ?></th>
		...
		<tr valign="top">
			<th scope="row" class="WLRequired"><?php _e('Body', 'unilevel-mlm-pro'); ?></th>
			<td>
				...
				<ul id="nav">
					<li><a href="javascript:return false;"> &nbsp; Merge codes </a>
						<ul>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[firstname]','<?php echo $x; ?>')"><?php _e('Insert First Name', 'unilevel-mlm-pro'); ?></a> </li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[lastname]','<?php echo $x; ?>')"><?php _e('Insert Last Name', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[email]','<?php echo $x; ?>')"><?php _e('Insert Email', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[username]','<?php echo $x; ?>')"><?php _e('Insert Username', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[amount]','<?php echo $x; ?>')"><?php _e('Insert Amount', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[sitename]','<?php echo $x; ?>')"><?php _e('Insert Sitename', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[payoutid]','<?php echo $x; ?>')"><?php _e('Insert Payout Id', 'unilevel-mlm-pro'); ?></a></li>
						</ul>
					</li>
				</ul>
				<br clear="all" />
				<?php _e('If you would like to insert info for the individual member<br />please click the merge field codes on the right.', 'unilevel-mlm-pro'); ?>
			</td>
		</tr>
...
<td style="border:none"><input type="checkbox" name="payout_mail" value="1" <?php if($x=get_option('payout_mail', true)==1) echo "checked"; ?>/>Enable this Mail</td>
     	...
     	<h3 style="margin-bottom:0"><?php _e('Network Growing Mail', 'unilevel-mlm-pro'); ?> </h3>
	<table class="form-table">
				...
				<ul id="nav">
					<li><a href="javascript:return false;"> &nbsp; Merge codes </a>
						<ul>
							...
							<li><a href="javascript:;" onclick="mlm_insertHTML('[email]','<?php echo $x; ?>')"><?php _e('Insert Email', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[username]','<?php echo $x; ?>')"><?php _e('Insert Username', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[sponsor]','<?php echo $x; ?>')"><?php _e('Insert Sponsor', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[sitename]','<?php echo $x; ?>')"><?php _e('Insert Sitename', 'unilevel-mlm-pro'); ?></a></li>
...
<td style="border:none"><input type="checkbox" name="network_mail" value="1" <?php if($w=get_option('network_mail', true)==1) echo "checked"; ?> />Enable this Mail</td>
             	...
             	<h3 style="margin-bottom:0"><?php _e('Withdrawal Intiated Mail', 'unilevel-mlm-pro'); ?> </h3>
	<table class="form-table">
				...
				<ul id="nav">
					<li><a href="javascript:return false;"> &nbsp; Merge codes </a>
						<ul>
							...
							<li><a href="javascript:;" onclick="mlm_insertHTML('[email]','<?php echo $x; ?>')"><?php _e('Insert Email', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[username]','<?php echo $x; ?>')"><?php _e('Insert Username', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[password]','<?php echo $x; ?>')"><?php _e('Insert Password', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[loginurl]','<?php echo $x; ?>')"><?php _e('Insert Login URL', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[memberlevel]','<?php echo $x; ?>')"><?php _e('Insert Membership Level', 'unilevel-mlm-pro'); ?></a></li>
						</ul>
					</li>
				</ul>
				<br clear="all" />
...
<td style="border:none"><input type="checkbox" name="withdrawal_mail" value="1" <?php if($v=get_option('withdrawal_mail', true)==1) echo "checked"; ?> />Enable this Mail</td>
                 	...
                 	<h3 style="margin-bottom:0"><?php _e('Withdrawal Processed Mail', 'unilevel-mlm-pro'); ?> </h3>
	<table class="form-table">
				...
				<ul id="nav">
					<li><a href="javascript:return false;"> &nbsp; Merge codes </a>
						<ul>
							...
							<li><a href="javascript:;" onclick="mlm_insertHTML('[username]','<?php echo $x; ?>')"><?php _e('Insert Username', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[amount]','<?php echo $x; ?>')"><?php _e('Insert Amount', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[withdrawalmode]','<?php echo $x; ?>')"><?php _e('Insert Withdrawal Mode', 'unilevel-mlm-pro'); ?></a></li>
							<li><a href="javascript:;" onclick="mlm_insertHTML('[sitename]','<?php echo $x; ?>')"><?php _e('Insert Sitename', 'unilevel-mlm-pro'); ?></a></li>
						</ul>
					</li>
				</ul>
...
<td style="border:none"><input type="checkbox" name="process_withdrawal_mail" value="1"  <?php if($u=get_option('process_withdrawal_mail', true)==1) echo "checked"; ?>/>Enable this Mail</td>
	...
	<p class="submit">
		...
		<input type="submit" name="MLMMemberAction" class="button-primary" value="<?php _e('Save Settings', 'unilevel-mlm-pro'); ?>" />
	</p>
</form>
