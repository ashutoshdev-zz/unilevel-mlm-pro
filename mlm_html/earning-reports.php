...
<?php
	...
	$total_amount=$wpdb->get_var("SELECT sum(product_price) as total from {$table_prefix}mlm_users WHERE payment_status='1' AND payment_date BETWEEN '$datefromfinal' AND '$datetofinal'");
	}
	else
	{
		$total_paid_users='0';
