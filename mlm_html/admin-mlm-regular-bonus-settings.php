...
<?php
	...
	<br\>
		...
		?>
        	<TR>
           		<TD align="left" width="12%"><INPUT type="checkbox" name="chk[]"/></TD>
				<TD align="left" width="44%"> <INPUT type="text" name="per_ref[]" size="15" value="<?php  echo   $mlm_settings['per_ref'][$i]?>"/> </TD>
				
				<TD align="left" width="44%"> <INPUT type="text" name="pay_value[]" size="15" value="<?php  echo   $mlm_settings['pay_value'][$i]?>"/> </TD>
