		  ...
		  <tr>
			<td width="40%" valign="top">
				<table width="100%" border="0" cellspacing="10" cellpadding="1">
				  ...
				  <tr>
		<td><a href="<?php  echo   get_post_id_or_postname('mlm_update_profile_page','unilevel-mlm-pro');?>" style="text-decoration: none"><?php _e('Edit','unilevel-mlm-pro');?></a></td>
		<td><a href="<?php  echo   get_post_id_or_postname('mlm_network_genealogy_page','unilevel-mlm-pro');?>" style="text-decoration: none"><?php _e('View Genealogy','unilevel-mlm-pro');?></a></td>
		</tr>
				</table> 
					<table width="100%" border="0" cellspacing="10" cellpadding="1">
				  <tr>
...
$mlm_settings = get_option('wp_mlm_general_settings');
	...
	?>
				  ...
				  <tr>
					...
					<td>
						<table width="100%" border="0" cellspacing="10" cellpadding="1">
							...
							<tr>
								<td><?php _e('My Personal Sales','unilevel-mlm-pro');?>: <?php  echo   $personalSales?></td>
			<td><?php _e('Active','unilevel-mlm-pro');?>: <?php  echo   $activePersonalSales?></td>
							</tr>
							<?php
		...
		?>
							<tr>
		<td colspan="2"><a href="?page_id=<?php  echo   $view_memberpage_id?>&lvl=1" style="text-decoration: none"><?php _e('View All','unilevel-mlm-pro');?></a></td>
		</tr>
