...
<div class='wrap1'>
	...
	<div class="notibar msginfo">
		...
		<p><strong><?php _e('Commission Type','unilevel-mlm-pro');?> - </strong><?php _e('Select whether the commission amounts specified are absolute numbers or percentage figures.','unilevel-mlm-pro');?></p>
...
<?php
	...
	{
?>
		<form name="admin_payout_settings" method="post" action="" onsubmit="return check_total_amount('<?php echo $mlm_no_of_level; ?>');">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="form-table">

    <tr>
	<th scope="row" class="admin-settings"><?php _e('Commission Type','unilevel-mlm-pro');?> :</th>
	<td>
	<select name="commission_type" id="commission_type" >
    <option value="fixed" <?php if($_POST['commission_type']=='fixed') { echo 'selected'; } ?> >Fixed </option>
	<option value="percent" <?php if($_POST['commission_type']=='percent') { echo 'selected'; } ?>>Percent </option>
	</select>
	</td></tr>	
	...
	<th scope="row" class="admin-settings">
			...
			<td>
			<input type="text" name="company_commission_amount" id="company_commission_amount" size="10" value="<?php if(isset($_POST['company_commission_amount'])) _e(htmlentities($_POST['company_commission_amount']));?>"><?php if($_POST['commission_type']=='percent') { echo '%'; } ?>
	...
	<th scope="row" class="admin-settings">
			...
			<td>
			<input type="text" name="referral_commission_amount" id="referral_commission_amount" size="10" value="<?php if(isset($_POST['referral_commission_amount'])) _e(htmlentities($_POST['referral_commission_amount']));?>"><?php if($_POST['commission_type']=='percent') { echo '%'; } ?>
...
<th scope="row" class="admin-settings">
			...
			<td>
			<input type="text" name="level<?php echo $j; ?>_commission" id="level<?php echo $j; ?>_commission" size="10" value="<?php if(isset($_POST['level'.$j.'_commission'])) _e(htmlentities($_POST['level'.$j.'_commission']));?>"><?php if($_POST['commission_type']=='percent') { echo '%'; } ?>
...
<?php  }  ?>
	...
	<td>
	<select name="commission_type" id="commission_type" >
    <option value="fixed" <?php if($mlm_settings['commission_type']=='fixed') { echo 'selected'; } ?> >Fixed </option>
	<option value="percent" <?php if($mlm_settings['commission_type']=='percent') { echo 'selected'; } ?>>Percent </option>
	</select>
	</td></tr>	
	...
	<th scope="row" class="admin-settings">
			...
			<td>
			<input type="text" name="company_commission_amount" id="company_commission_amount" size="10" value="<?php if(isset($mlm_settings['company_commission_amount'])) _e($mlm_settings['company_commission_amount'],'unilevel-mlm-pro');?>"><?php if($mlm_settings['commission_type']=='percent') { echo '%'; } ?>
				<div class="toggle-visibility" id="admin-mlm-company_commission_amount"><?php _e('Please specify Company commission.','unilevel-mlm-pro');?></div>
			</td>
		</tr>
		<tr>
	<th scope="row" class="admin-settings">
			...
			<td>
			<input type="text" name="referral_commission_amount" id="referral_commission_amount" size="10" value="<?php if(isset($mlm_settings['referral_commission_amount'])) _e($mlm_settings['referral_commission_amount'],'unilevel-mlm-pro');?>"><?php if($mlm_settings['commission_type']=='percent') { echo '%'; } ?>
				<div class="toggle-visibility" id="admin-mlm-referral_commission_amount"><?php _e('Please specify referral commission.','unilevel-mlm-pro');?></div>
			</td>
		</tr>
...
<th scope="row" class="admin-settings">
			...
			<td>
			<input type="text" name="level<?php echo $j; ?>_commission" id="level<?php echo $j; ?>_commission" size="10" value="<?php if(isset($mlm_settings['level'.$j.'_commission'])) _e($mlm_settings['level'.$j.'_commission']);?>"><?php if($mlm_settings['commission_type']=='percent') { echo '%'; } ?>
				<div class="toggle-visibility" id="admin-mlm-level<?php echo $j; ?>-commission"><?php _e('Please specify Level '.$j.' Commission.','unilevel-mlm-pro');?></div>
			</td>
		</tr>
