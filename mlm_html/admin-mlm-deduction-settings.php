	...
	<TABLE id="dataTable"  cellspacing="5" cellpadding="5" border="0" width="450">
		<TR>
			...
			<select name="withdwl_type[]" id="withdwl_type">
				...
				<option value="fixed" <?php  echo   (isset($_POST['withdwl_type']) && $_POST['withdwl_type']=='fixed') ? 'selected':''?>><?php _e('Fixed','unilevel-mlm-pro');?></option>
				<option value="percent" <?php  echo   (isset($_POST['withdwl_type']) && $_POST['withdwl_type']=='percent') ? 'selected':''?>><?php _e('Percentage','unilevel-mlm-pro');?></option>
				</select> </TD>
...
<?php
	...
	<br\>
		...
		?>
			...
			<select name="withdwl_type[]" id="withdwl_type">
				<option value=""><?php _e('Select Type','unilevel-mlm-pro');?></option>
				<option value="fixed" <?php  echo   $mlm_withdrawal_settings['withdwl_type'][$i]=='fixed' ? 'selected':''?>><?php _e('Fixed','unilevel-mlm-pro');?></option>
				<option value="percent" <?php  echo   $mlm_withdrawal_settings['withdwl_type'][$i]=='percent' ? 'selected':''?>><?php _e('Percentage','unilevel-mlm-pro');?></option>
				</select> </TD>
	...
	<TABLE id="dataWithDrawalTable"  cellspacing="5" cellpadding="5" border="0" width="450">
		<TR>
			...
			<select name="othr_type[]" id="othr_type">
				<option value=""><?php _e('Select Type','unilevel-mlm-pro');?></option>
				<option value="fixed" <?php  echo   (isset($_POST['othr_type']) && $_POST['othr_type']=='fixed') ? 'selected':''?>><?php _e('Fixed','unilevel-mlm-pro');?></option>
				<option value="percent" <?php  echo   (isset($_POST['othr_type']) && $_POST['othr_type']=='fixed') ? 'selected':''?>><?php _e('Percentage','unilevel-mlm-pro');?></option>
				</select> </TD>
		</TR>
	</TABLE>
...
<?php
	...
	<br\>
		...
		?>
			...
			<select name="othr_type[]" id="othr_type">
				<option value=""><?php _e('Select Type','unilevel-mlm-pro');?></option>
				<option value="fixed" <?php  echo   $mlm_other_settings['othr_type'][$i]=='fixed' ? 'selected':''?>><?php _e('Fixed','unilevel-mlm-pro');?></option>
				<option value="percent" <?php  echo   $mlm_other_settings['othr_type'][$i]=='percent' ? 'selected':''?>><?php _e('Percentage','unilevel-mlm-pro');?></option>
				</select> </TD>
