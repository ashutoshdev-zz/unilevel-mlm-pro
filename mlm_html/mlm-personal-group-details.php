			...
			<div class="va-admin-leg-details">
				...
				<div class="paging">
				  <form action="">
					...
					<?php _e('Total Users','unilevel-mlm-pro');?>: <strong><?php  echo   $personalLegUsers; ?></strong>&nbsp;<?php _e('Active Users','unilevel-mlm-pro');?>: <strong><?php  echo   $personalLegActiveUsers; ?></strong>
					</div>
