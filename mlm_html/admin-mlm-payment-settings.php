...
<span class="edit">
<a class="edit-payment-module" data-gateway-id="paypal" title="Edit this Payment Gateway's Settings" href="<?php  echo   $pageurl?>&amp;payment_gateway_id=paypal">Edit</a></span></div>
...
<div class="wpsc-gateway-actions">
<span class="edit">
<a class="edit-payment-module" data-gateway-id="cardsave" title="Edit this Payment Gateway's Settings" href="<?php  echo   $pageurl?>&amp;payment_gateway_id=cardsave">Edit</a></span></div>
<p>
...
<div class="inside">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="60%" class="form-table">
		...
		<input type="text" name="mlm-site-address" id="mlm-site-address" size="30" value="<?php if(!empty($mlm_settings['mlm-site-address'])) _e($mlm_settings['mlm-site-address']);?>">
		      ...
		      <tr>
                          <th scope="row" class="admin-settings"><a style="cursor:pointer;" title="Click for Help!" onclick="toggleVisibility('admin-mlm-item_name');"><?php _e('Product Name:','unilevel-mlm-pro');?></a>
      </th>
      <td>
      <input type="text" size="30" value="<?php if(!empty($mlm_settings['item_name'])) _e($mlm_settings['item_name'],'unilevel-mlm-pro');?>" name="item_name">
      <div class="toggle-visibility" id="admin-mlm-item_name"><?php _e('Please specify Product Name.','unilevel-mlm-pro');?></div>
      </td>
      </tr>
		<tr>
			<th scope="row" class="admin-settings">
...
<tr>
  ...
  <tr>
      <td><?php _e('Product Name:','unilevel-mlm-pro');?>
      </td>
      <td>
  ...
  <tr>
  	...
  	<?php _e('This will be shown Product Name at PayPal Gateway.','unilevel-mlm-pro');?>
  	</span>
  	</td>
  </tr>
...
<tr>
     ...
     <tr>
      ...
      <td>
      <input type="text" size="40" value="<?php if(!empty($paypal_settings['item_name'])) _e($paypal_settings['item_name'],'unilevel-mlm-pro');?>" name="item_name">
      </td>
  </tr>
  <tr>
  	<td></td>
