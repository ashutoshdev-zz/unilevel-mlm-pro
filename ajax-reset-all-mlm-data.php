...
if($_POST['name'] == 'reset_data' && is_super_admin() )
{
	...
	delete_option('wp_mlm_product_price_settings');
	delete_option('wp_mlm_payment_method');
	delete_option('wp_mlm_paypal_settings');
	delete_option('wp_mlm_paypal_field_settings');
	...
	$wpdb->query( "TRUNCATE TABLE {$table_prefix}mlm_product_price");
