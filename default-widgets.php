	...
	?>  
			<div class="join_box">
				...
				<div class="join_box_right">
					...
					?>
					<a class="subscribe button-primary" href="<?php  echo   get_post_id_or_postname('mlm_registration_page','unilevel-mlm-pro');?>/">Join Now</a>
				</div>
			</div>
	<?php 
		} else{ 
			...
			?>
				<div class="join_box">
					...
					<div class="join_box_right">
						...
						?>
						<a class="subscribe button-primary" href="<?php  echo   get_post_id_or_postname('mlm_registration_page','unilevel-mlm-pro');?><?php  echo  $concat?>sp_name=<?php  echo  $sp_name; ?>">Join Now</a>
					</div>
				</div>
	<?php 	
			}
